...
- **ADP Workforce Now: land no ADP test client, and re-run `scripts/validate/adp_company_names.py`
  ...
  thousand: "BVT Analyst_…", "RECT AUTO REQS_…", "NEW" at "BVT Location, Anchorage, AK" (36 were
  excluded on 2026-09-26, ADR-0241). The script caches each new client's `ClientName`, which the
  ...
  is a lead, not proof. `WFN - The McDonnel Group` is a real employer, and 6 of the 36 had no
  such name.
