...
# in ~9 min, so a 10-15 min Board set the wall clock unjudged: `jibe:petsmart`, 760 s at a score of 2.8
# (4 tech jobs). On score, every fresh Board measured between 10 and 15 min then sat under 2 tech/
# min and none between 6 and 10 min did; `jibe:ulta` is borderline on a still-warming score
# (ADR-0064 amendment).
