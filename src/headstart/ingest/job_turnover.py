...
of the turnover, as they already do for net (``hot_boards.counting_changes``,
``trend_netting``). A job opened and closed between two scrapes of its Board is in no count at all, so
