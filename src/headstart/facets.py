...
Exposed as one function, :func:`counts`, which takes the parsed :class:`headstart.search_filters.
SearchFilters` and the table's :class:`headstart.search_filters.IndexCapabilities` (ADR-0149) and returns
