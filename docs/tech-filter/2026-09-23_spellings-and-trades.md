...
Version 4 went through two critiques and two code reviews before landing. A critique rated
...
|---|---|---|
| **blind hold-out recall** (English Indeed, 800 titles, weighted to 557,580 rows) | n/a | **84.7%** (77.6–89.7%) |
| **blind hold-out precision** | n/a | **81.1%** (76.0–85.3%) |
| dev-silver recall (English Indeed rows whose description has ≥5 core dev tokens, n=45,370) | 90.28% | 92.13% |
| served table kept (v654, 514,163 rows) | 513,389 | 497,097 (+1 in, −16,293 out) |
| pre-filter snapshot kept (332,383 rows, July) | 68,600 | 69,316 (+1,852 in, −1,136 out) |
| English + non-English Indeed kept (679,687 rows) | 160,294 | 163,624 (+7,830 in, −4,500 out) |
| speed (150k titles, best of two) | 32.9k rows/s | 32.5k rows/s |
...
was read by hand.** That is 6,865 unique titles, read in three passes:
...
- **Frameworks and platforms:** Ruby on Rails developers; JD Edwards CNC administrators; Epic EDI
  developers; PLM/Teamcenter admins.
- **Security and presales:** a cybersecurity platform manager; software presales solutions
  consultants in "Sales Engineering" departments.
...
- **Rule 4:**
  ...
  - Not a department of just "Security", which holds infosec teams.
- **Strong arms respect vetoes:** "Sales Engineer – AI", "Cyber Sales Manager" and "Cyber
  Claims Specialist" no longer override them.
...
- **Speed:**
  ...
  - v4's longer list had cost 2.4x; this is back to v3's speed.
...
- **The hold-out's 22 misses:** mostly IT and business-systems titles ("ICT Business Analyst",
