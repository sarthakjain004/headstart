...
| Search filter | `search.build_filter`; Facets' lifted dimension; UI controls, active pills and defaults | `test_search.py`, `test_facets.py`, real-source JS tests; live harness when semantics change |
