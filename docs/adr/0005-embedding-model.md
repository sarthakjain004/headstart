...
The first slice of AI semantic retrieval (see `docs/AI_Integration/`) is built over `data/jobs/sidecorpus.csv`
...
Sidecorpus description embeds whole — no truncation of the 82% that overflow 512), **English-focused**
