...
(`board_identity` and `scrapable_boards` keep their names; test naming in existing packages) and
[ADR-0237](0237-trend-history-keeps-its-name-inside-trends.md) (`trend_history` keeps its name)
