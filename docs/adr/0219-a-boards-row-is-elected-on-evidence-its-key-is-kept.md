...
**Amended 2026-09-25 ([#661](https://github.com/sarthakjain004/headstart/issues/661)).** The
prober now does this. When a data centre other than the row's own answers, `p_workday` returns
the row's url with that `wdN` swapped in, keeping the casing and any query string, and the ledger
