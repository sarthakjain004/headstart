...
Space serves, which a new ATS has none of until the pipeline runs, and it signs in with a
session cookie only the user can refresh (a Google sign-in); name that deferral in the PR and at
