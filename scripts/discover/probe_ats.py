...
LATEST = json.loads(cc_miner.curl("https://index.commoncrawl.org/collinfo.json"))[0]["cdx-api"]
...
CANDIDATES = [
    "peoplestrong.com", "hrone.cloud", "zinghr.com", "myadrenalin.com", "qandle.com",
    "sumhr.com", "factohr.com", "kredily.com", "pockethrms.com", "beehivehcm.com",
    "empxtrack.com", "ceipal.com", "recooty.com", "jobsoid.com", "ismartrecruit.com",
    "turbohire.co", "pitchnhire.com", "talent500.co", "skillate.com", "springrecruit.com",
    "expertia.ai", "jobma.com", "talview.com", "zwayam.com", "ripplehire.com",
    "workable.com", "recruitee.com", "smartrecruiters.com", "hrmantra.com", "keka.hire",
]

results = []
for dom in CANDIDATES:
    body = cc_miner.curl(f"{LATEST}?url={dom}&matchType=domain&output=json&fl=url&limit=4000")
    hosts = set()
