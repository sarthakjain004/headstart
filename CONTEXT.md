...
**Hiring Board** — 101,114:
A Scrapable Board with at least one open posting (`load_active_companies(min_jobs=1)`, the function's default). The other 52,422 are live but empty.
