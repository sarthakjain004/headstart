...
[![ADRs](https://img.shields.io/badge/ADRs-196-blue)](./docs/adr/)
...
And every limit ships next to the result it qualifies. 196 ADRs record the options that lost,
...
**Record the rejected options, not just the chosen one.** 196 ADRs, **133** carrying a heading that
...
- **Design decisions:** [`docs/adr/`](./docs/adr/) — 196 numbered ADRs (the option picked, the
