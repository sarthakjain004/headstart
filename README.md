...
The liveness pipeline has probed **257,761 ledger rows**: 153,215 live, 88,455 dead, 16,091 unknown
— rows, not boards; they collapse to 146,583 Unique Boards once duplicate spellings of the same
...
flowchart TB
    subgraph D["① Discovery &nbsp;·&nbsp; occasional, by hand"]
        ...
        D4[("<b>liveness ledger</b><br/>153,215 live rows of 257,761<br/>git-tracked, authoritative")]
        D1 --> D2 --> D3 --> D4
    end
...
| | boards | |
| --- | ---: | --- |
| live rows in the ledger | 153,215 | a row, not a board — 6,632 of them are duplicate spellings |
...
because two excluded boards were themselves duplicates. Both land on 120,965.

Of those, **78,495 are currently hiring** — the 42,470 live-but-empty boards are skipped as having
