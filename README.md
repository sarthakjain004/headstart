...
The liveness pipeline has probed **278,291 ledger rows**: 162,774 live, 99,250 dead, 16,267 unknown
— rows, not boards; they collapse to 156,142 Unique Boards once duplicate spellings of the same
...
flowchart TB
    subgraph D["① Discovery &nbsp;·&nbsp; occasional, by hand"]
        ...
        D4[("<b>liveness ledger</b><br/>162,774 live rows of 278,291<br/>git-tracked, authoritative")]
        D1 --> D2 --> D3 --> D4
    end
...
| | boards | |
| --- | ---: | --- |
| live rows in the ledger | 162,774 | a row, not a board — 6,632 of them are duplicate spellings |
...
because two excluded boards were themselves duplicates. Both land on 130,190.

Of those, **84,749 are currently hiring** — the 45,441 live-but-empty boards are skipped as having
